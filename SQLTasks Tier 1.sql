...
SELECT sub.firstname, sub.surname, CONCAT_WS(  ' ', sub.rfirstname, sub.rsurname ) AS recommendedby
FROM (
SELECT a.firstname AS firstname, a.surname AS surname, b.firstname AS rfirstname, b.surname AS rsurname
FROM Members AS a
CROSS JOIN Members AS b ON a.recommendedby = b.memid
)sub
